		...
		:submitButtonStyles='{
			...
			"submit": {
				"container": {
					...
					"hover": {"backgroundColor": "#b0deff4f","boxShadow": "0px 0.3px 0.9px rgba(0, 0, 0, 0.12), 0px 1.6px 3.6px rgba(0, 0, 0, 0.16)"},
					"click": {"backgroundColor": "#b0deffb5","boxShadow": "0px 0.3px 0.9px rgba(0, 0, 0, 0.12), 0px 1.6px 3.6px rgba(0, 0, 0, 0.16)"}
				},
				"svg": {
