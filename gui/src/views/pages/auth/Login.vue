...
<template>
    <div class="surface-ground flex align-items-center justify-content-center min-w-screen overflow-hidden login-overflow-hidden">
        <Toast position="bottom-center" group="login" @close="onClose">
				...
				<svg class="svg-opacity-07" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 800" class="fixed left-0 top-0 min-h-screen min-w-screen" preserveAspectRatio="none"><rect fill="var(--p-primary-500)" width="1600" height="800"></rect><path fill="var(--p-primary-400)" d="M478.4 581c3.2 0.8 6.4 1.7 9.5 2.5c196.2 52.5 388.7 133.5 593.5 176.6c174.2 36.6 349.5 29.2 518.6-10.2V0H0v574.9c52.3-17.6 106.5-27.7 161.1-30.9C268.4 537.4 375.7 554.2
				...
				<div class="flex flex-column align-items-center justify-content-center login-form-wrapper">
                ...
                <div class="shadow w-full surface-card py-7 px-4 sm:px-8" style="border-radius: 0px;">
                    <div class="flex mb-5">
                        ...
                        <img :src="XeyeSvg" height="55" class="mr-3" alt="Xeye" />
												<div>
										    <div class="text-3xl font-medium mb-2 font-bold login-title">ZTM</div>
										    <span class="font-medium login-subtitle">Sign in to continue</span>
												</div>
										</div>
                    <div>
											<InputGroup class="mb-3 w-24rem">
											    ...
											    <InputText id="email1" type="text" placeholder="User" class="login-input-padding" v-model="user" />
											</InputGroup>
                        ...
                        <div class="flex align-items-center justify-content-between mb-5 gap-5">
                            <div class="flex align-items-center">
                                ...
                                <label for="rememberme1" class="login-label">Remember me</label>
                            </div>
                            <!-- <a class="font-medium no-underline ml-2 text-right cursor-pointer" style="color: var(--p-primary-color)">Forgot password?</a> -->
                        </div>
