...
<template>
	...
	<Tag size="small" v-else severity="secondary">
		<i  @click="enterVal" class="pi pi-times opacity-70"/>
		<input style="background-color: transparent;border-style: none none solid none; border-width: 1px;border-color: #aaa;" @keyup.enter="enterVal" type="text" v-model="inputVal"/>
		<i  @click="isEdit = false" class="pi pi-check opacity-70"/>
	</Tag>
</template>
